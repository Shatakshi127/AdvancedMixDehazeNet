...
parser.add_argument('--no_autocast', action='store_false', default=True, help='disable autocast')
parser.add_argument('--save_dir', default='./saved_models/', type=str, help='path to models saving')
parser.add_argument('--data_dir', default='E:/Thapar/Computer Science/#A NEW RIVERIA/Conversational AI- Advanced DS/Project/Hazing_Project/MixDehazeNet/Dataset/', type=str, help='path to dataset')
parser.add_argument('--log_dir', default='./logs/', type=str, help='path to logs')
parser.add_argument('--dataset', default='TrainDataHazy', type=str, help='dataset name')
parser.add_argument('--exp', default='haze4k', type=str, help='experiment setting')
parser.add_argument('--gpu', default='3,2,0', type=str, help='GPUs used for training')
args = parser.parse_args()
