...
class PairLoader(Dataset):
    def __init__(self, mode, size=256, edge_decay=0, only_h_flip=False):
        assert mode in ['train', 'valid', 'test']
        ...
        if mode == 'train':
            data_dir = r"E:\Thapar\Computer Science\#A NEW RIVERIA\Conversational AI- Advanced DS\Project\Hazing_Project\MixDehazeNet\Dataset\TrainDataHazy"
        elif mode == 'valid':
            data_dir = r"E:\Thapar\Computer Science\#A NEW RIVERIA\Conversational AI- Advanced DS\Project\Hazing_Project\MixDehazeNet\Dataset\ValidationHazy"
        else:
