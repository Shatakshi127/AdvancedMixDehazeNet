...
if __name__ == '__main__':
    ...
    # Prepare the dataset
    train_dataset_dir = "E:\\Thapar\\Computer Science\\#A NEW RIVERIA\\Conversational AI- Advanced DS\\Project\\Hazing_Project\\MixDehazeNet\\Dataset\\TrainDataHazy"
    val_dataset_dir = "E:\\Thapar\\Computer Science\\#A NEW RIVERIA\\Conversational AI- Advanced DS\\Project\\Hazing_Project\\MixDehazeNet\\Dataset\\ValidationHazy"
    
    train_dataset = SingleLoader(train_dataset_dir)
    val_dataset = SingleLoader(val_dataset_dir)
    ...
    train_result_dir = os.path.join(args.result_dir, 'Train', args.model)
    val_result_dir = os.path.join(args.result_dir, 'Validation', args.model)
    
    # Perform testing on training data
    test(train_loader, network, train_result_dir)
    
    # Perform testing on validation data
    test(val_loader, network, val_result_dir)
