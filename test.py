...
if __name__ == '__main__':
    ...
    train_dataset_dir = os.path.join(args.data_dir, 'TrainDataHazy')
    validation_dataset_dir = os.path.join(args.data_dir, 'ValiadtionHazy')

    test_dataset = PairLoader(validation_dataset_dir, 'validation', 'validation')
    test_loader = DataLoader(test_dataset,
                             batch_size=1,
                             num_workers=args.num_workers,
                             pin_memory=True)
